...
//
//
//class MeetingDe3Activity : BaseBindingActivity<ActMeetda2Binding, BaseViewModel>() {
//
...
//                            .activityInstanceIsLive(this@MeetingDe3Activity)
//                    ) {
//                        if (userType.equals("01") || userType.equals("04")) {
//                            getData()
//                            getList()
...
//                val from = arrayOf("name", "num1", "num2", "num3", "num4")
//                val to = intArrayOf(R.id.name, R.id.num1, R.id.num2, R.id.num3, R.id.num4)
//                for (d in list) {
//                    Log.d("aaaaprintUnitXXPermissions", "hhh==="+d.name)
//                    var a = HashMap<String,String>()
//                    a.put("name",d.name)
//                    a.put("num1",""+d.locationCount)
//                    a.put("num2",""+d.beSignInCount)
//                    a.put("num3",""+d.signInCount)
//                    a.put("num4",""+d.unSignInCount)
//                    dataList.add(a)
//                }
//                var simpleAdapter = SimpleAdapter(
//                    this, dataList, R.layout.list_meetingde1,
//                    from, to
//                );
...
//                        }
//                        var simpleAdapter = SimpleAdapter(
//                            this@MeetingDe3Activity, dataList, R.layout.list_meetingde1,
//                            from, to
//                        );
//                        binding.recyclerview.adapter = simpleAdapter
//                    } catch (e: java.lang.Exception) {
