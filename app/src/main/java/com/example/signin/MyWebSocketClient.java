 ...
 */
abstract class MyWebSocketClient extends AbstractWebSocket implements Runnable, WebSocket {
    ...
    public void run() {
        ...
        try {
            ...
            Log.e("JWebSocketClient", " sendHandshake()()");
            sendHandshake();
        ...
        writeThread = new Thread(new MyWebSocketClient.WebsocketWriteThread(this));
        writeThread.start();

        byte[] rawbuffer = new byte[WebSocketImpl.RCVBUF];
        int readBytes;
        Log.e("JWebSocketClient", " isClosing()()()=="+isClosing());

        Log.e("JWebSocketClient", " isClosing()()()=="+isClosing());
        try {
            Log.e("JWebSocketClient", " istream.read(rawbuffer)()()=="+istream.read(rawbuffer));
            Log.e("JWebSocketClient", " isClosed()()=="+isClosed());
            while (!isClosing() && !isClosed() && (readBytes = istream.read(rawbuffer)) != -1) {
                engine.decode(ByteBuffer.wrap(rawbuffer, 0, readBytes));
            }
            engine.eot();
        } catch (IOException e) {
            Log.e("JWebSocketClient", " handleIOException()()");
            handleIOException(e);
        } catch (RuntimeException e) {
            Log.e("JWebSocketClient", " RuntimeException()=="+ e.getMessage());
    ...
    private class WebsocketWriteThread implements Runnable {
        ...
        WebsocketWriteThread(MyWebSocketClient webSocketClient) {
