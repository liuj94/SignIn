...
//import com.example.signin.getNetworkStr
...
//    params["level"] = level
//    PutRequest(
//        PageRoutes.BANCOMMENT, JSON.toJSONString(params),
...
//    params["id"] = id
//    PutRequest(
//        PageRoutes.CANCELBANCOMMENT, JSON.toJSONString(params),
//        { success?.invoke() }, error, finish, { success?.invoke() })
//
//}
//
...
//    params["ids"] = ids
//    PutRequest(
//        PageRoutes.BATCHCANCELBANCOMMENT, JSON.toJSONString(params),
//        { success?.invoke() }, error, finish, { success?.invoke() })
//
//}
//
...
//
//    PutRequest(
//        PageRoutes.LIVEPUBLISH, JSON.toJSONString(params),
//        {
//            success?.invoke()
...
//
//    PutRequest(
//        PageRoutes.LIVESTART, JSON.toJSONString(params),
//        { success?.invoke() },
