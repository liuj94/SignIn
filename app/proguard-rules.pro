...
#webview文件选择防止被混淆
-keepclassmembers class com.zcitc.cloudhousehelper.helper.web.MyWebChromeClient{
...
-keep class com.zcitc.cloudhousehelper.** { *; }
-keepattributes *Annotation*
-keep class kotlin.** { *; }
...
-keep class com.ut.**{*;}
-keep class com.ta.**{*;}
-keep class com.zcitc.cloudhousehelper.mvvm.bean.**{*;}
...
-keep class com.zcitc.advertisement.**{*;}
-keep class com.zcitc.httplibrary.net.**{*;}
-keep class com.zcitc.utilslibrary.**{*;}
-keep class com.blankj.utilcode.**{*;}
-keep class com.zcitc.webviewlib.**{*;}
-keep class com.zcitc.baselibrary.**{*;}
-keep class com.zcitc.glidelibrary.**{*;}
-keep class com.zcitc.**{*;}
-keep class com.example.signin.**{*;}
